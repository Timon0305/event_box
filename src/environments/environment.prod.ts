export const environment = {
  production: true,
  baseApiURL: 'https://api.myeventbox.com',
  s3BaseUrl: 'https://eventbox-prod.s3.amazonaws.com/',
  baseUrl: '',
  social: {
    FacebookAppId: '204623054075048',
    GoogleClientId : '726719960128-0mua3jkceqgvts0r0jq3t1or4il25lrr',
    stripePublishableKey: 'pk_live_ldMHU9yqqvNmSGYv2HZs2G0j00n14mJ0e3'
  },
  firebase: {
  ...
  secure: true,
  appUrl: 'https://www.myeventbox.com'
};
